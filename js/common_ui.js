...
/* 터치 가능기간 확인 2022-03-15 */
function touch_mo() {
	if(navigator.maxTouchPoints > 1) {
		$('body').addClass('touch_mob');
	} else {
		$('body').removeClass('touch_mob');
	}
}
...
$(document).ready(function(){
	function gnbAction() {
		...
		function pc_gnb() {
			...
			$(gnbmenu).on({
				click:function(e) {
					$(mainNav).stop().animate({height:340},500); //2022-06-20 그림그래프 추가하여 높이 수정
				},
...
/* ga 제거후 ga 함수 사용하는 코드 오류 제거용 : 20220609 */
